...
class Test7(SASRec):
    ...
    def _init_model(self, train_data):
        ...
        self.augmentation_model = data_augmentation.GSL2Augmentation(self.config['model'], train_data)
    ...
    def training_step(self, batch):
        ...
        cl_output = self.augmentation_model(batch, self.item_encoder.weight[:-1], self.query_encoder)
    ...
    def training_epoch(self, nepoch):
        self.augmentation_model.train_kmeans(self.item_encoder.weight[:-1], self._parameter_device)
